...
this.matherProcess = function(data) {

            var promise = httpAsPromise(
                {
                    method: 'POST',
                    url: 'http://localhost:8080/jsflab/rest/ERPIntegrater/getPOERPDetails',
                    data: data
                }
            );
        ...
        this.formFieldSave = function(data) {

            var promise = httpAsPromise(
                {
                    method: 'POST',
                    url: 'http://localhost:8080/jsflab/rest/DBDuplicateCheck/save',
                    data: data
                }
            );
        ...
        this.duplicateCheck = function(data) {

            var promise = httpAsPromise(
                {
                    method: 'POST',
                    url: 'http://localhost:8080/jsflab/rest/DBDuplicateCheck/checkForDuplicate',
                    data: data
                }
            );
