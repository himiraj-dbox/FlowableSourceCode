    ...
    .controller('FormBuilderController', ['$rootScope', '$scope', '$translate', '$http', '$timeout', '$location', '$modal', '$routeParams', '$popover', 'FormBuilderService',
        function ($rootScope, $scope, $translate, $http, $timeout, $location, $modal, $routeParams, $popover, FormBuilderService) {
            ...
            $scope.onFieldDrop = function (paletteElementOrField, dropArrayTarget, event, index) {
                ...
                if(paletteElementOrField && paletteElementOrField.type == 'pdf-viewer'){
                    $rootScope.viewSplitFunction = true;
                }
               ...
               if(fieldId == 'pdf-viewer'){
                   field.options = [{
                       src:'images/form-builder/pdfviewer.png'
                   }
            ...
            $scope.palletteElements = [
                {'type': 'text', 'title': $translate.instant('FORM-BUILDER.PALLETTE.TEXT'), 'icon': 'images/form-builder/textfield-icon.png', 'width': 1,'show-dialog':false,'styleClassVal':'normal'},
                {'type': 'password', 'title': $translate.instant('FORM-BUILDER.PALLETTE.PASSWORD'), 'icon': 'images/form-builder/password-icon.png', 'width': 1,'show-dialog':false,'styleClassVal':'normal'},
                {'type': 'multi-line-text', 'title': $translate.instant('FORM-BUILDER.PALLETTE.MULTILINE-TEXT'), 'icon': 'images/form-builder/multi-line-textfield-icon.png', 'width': 1,'show-dialog':false,'styleClassVal':'normal'},
                {'type': 'integer', 'title': $translate.instant('FORM-BUILDER.PALLETTE.NUMBER'), 'icon': 'images/form-builder/numberfield-icon.png', 'width': 1,'show-dialog':false,'styleClassVal':'normal'},
                {'type': 'decimal', 'title': $translate.instant('FORM-BUILDER.PALLETTE.DECIMAL'), 'icon': 'images/form-builder/decimalfield-icon.png', 'width': 1,'show-dialog':false,'styleClassVal':'normal'},
                {'type': 'boolean', 'title': $translate.instant('FORM-BUILDER.PALLETTE.CHECKBOX'), 'icon': 'images/form-builder/booleanfield-icon.png', 'width': 1,'show-dialog':false,'styleClassVal':'normal'},
                {'type': 'date', 'title': $translate.instant('FORM-BUILDER.PALLETTE.DATE'), 'icon': 'images/form-builder/datefield-icon.png', 'width': 1,'show-dialog':false,'styleClassVal':'normal'},
                {'type': 'dropdown', 'title': $translate.instant('FORM-BUILDER.PALLETTE.DROPDOWN'), 'icon': 'images/form-builder/dropdownfield-icon.png', 'width': 1,'show-dialog':false,'styleClassVal':'normal'},
                {'type': 'radio-buttons', 'title': $translate.instant('FORM-BUILDER.PALLETTE.RADIO'), 'icon': 'images/form-builder/choicefield-icon.png', 'width': 1,'show-dialog':false,'styleClassVal':'normal'},
                {'type': 'people', 'title': $translate.instant('FORM-BUILDER.PALLETTE.PEOPLE'), 'icon': 'images/form-builder/peoplefield-icon.png', 'width': 1,'show-dialog':false,'styleClassVal':'normal'},
                {'type': 'functional-group', 'title': $translate.instant('FORM-BUILDER.PALLETTE.GROUP-OF-PEOPLE'), 'icon': 'images/form-builder/peoplefield-icon.png', 'width': 1,'show-dialog':false,'styleClassVal':'normal'},
                {'type': 'upload', 'title': $translate.instant('FORM-BUILDER.PALLETTE.UPLOAD'), 'icon': 'images/form-builder/uploadfield-icon.png', 'width': 1,'show-dialog':false,'styleClassVal':'normal'},
                {'type': 'expression', 'title': $translate.instant('FORM-BUILDER.PALLETTE.EXPRESSION'), 'icon': 'images/form-builder/readonly-icon.png', 'width': 1,'show-dialog':false,'styleClassVal':'normal'},
                {'type': 'hyperlink', 'title': $translate.instant('FORM-BUILDER.PALLETTE.HYPERLINK'), 'icon': 'images/form-builder/hyperlink-icon.png', 'width':1,'show-dialog':false,'styleClassVal':'normal'},
				{'type': 'spacer', 'title': $translate.instant('FORM-BUILDER.PALLETTE.SPACER'), 'icon': 'images/form-builder/spacer-icon.png', 'width':1,'show-dialog':false,'styleClassVal':'normal'},
				{'type': 'horizontal-line', 'title': $translate.instant('FORM-BUILDER.PALLETTE.HORIZONTAL-LINE'), 'icon': 'images/form-builder/horizontal-line-icon.png', 'width':1,'show-dialog':false,'styleClassVal':'normal'},
				{'type': 'headline', 'title': $translate.instant('FORM-BUILDER.PALLETTE.HEADLINE'), 'icon': 'images/form-builder/headline-icon.png', 'width':1,'show-dialog':false,'styleClassVal':'normal'},
                {'type': 'pdf-viewer', 'title': $translate.instant('FORM-BUILDER.PALLETTE.PDF-VIEWER'), 'icon': 'images/form-builder/pdfviewer.png', 'width':1,'show-dialog':false,'styleClassVal':'normal'}
            ];
