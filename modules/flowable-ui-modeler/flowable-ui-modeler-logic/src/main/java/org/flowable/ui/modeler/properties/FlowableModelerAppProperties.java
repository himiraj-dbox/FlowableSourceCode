...
public class FlowableModelerAppProperties {
     ...
     * Default url for the Flowable Task application is http://localhost:8080/DB-task/app-api
     */
    private String deploymentApiUrl = "http://localhost:8080/DB-task/app-api";
